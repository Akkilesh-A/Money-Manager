...
const SignInPage = () => {
  ...
  return (
       <div className='bg-purple-200 gap-8  flex flex-col m-auto justify-center items-center h-screen w-screen px-32 py-32 '>
        ...
        {signinRole=="PARENT" && <div className='md:flex justify-center items-center shadow-lg rounded-xl bg-white '>
            ...
            <form onSubmit={handleSubmit(onParentSubmit)} className=" lg:w-1/2 flex flex-col gap-4 justify-center p-16">
                ...
                <button disabled={isSubmitting} className='m-auto px-4 py-2 border bg-yellow-400 rounded-md font-semibold'>{isSubmitting ? "Loading..." : "Sign In!"}</button>
            </form>
        </div>}
